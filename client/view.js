...
var onLoad = function()
{
    ...
    var load = function(featureKey) {
        ...
        xhttp.onreadystatechange = ()=> {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                if (--todosCount == 0) {
                    drawTagCloud('div.left-block > div.tagCloud', 'countries', s=> $('#cSel').text("∀ countryKey ∊ "+s))
    ...
    // setup ui data dependencies
    // new Awesomplete('.feature', {
    //     list: features,
    //     autoFirst: true,
    //     minChars: 1,
